...
public class Order  {
    ...
    public static Order convertFromQuery(QueryDocumentSnapshot documentSnapshot) throws ParseException {
        ...
        if(m.get("ID").toString().startsWith("V")){
            ...
            videoCallOrder.DateAppoint= FirebaseNumberAndDateTimeProcess.stringToDate(m.get("DateAppoint").toString(),"MM/dd/yyyy");
            ...
            hospitalOrder.DateAppoint= FirebaseNumberAndDateTimeProcess.stringToDate(m.get("AppointmentDate").toString(),"MM/dd/yyyy");
    ...
    public static Map<String, Object> convertToMap(Order o){
        ...
        if(o.ID.startsWith("H")){
            ...
            order.put("Fee",o.Fee);
            order.put("AppointmentDate", FirebaseNumberAndDateTimeProcess.dateToString(o.DateAppoint,"MM/dd/yyyy"));
            ...
            order.put("PatientID",o.PatientID);
            order.put("Fee",o.Fee);
            order.put("DateAppoint", FirebaseNumberAndDateTimeProcess.dateToString(o.DateAppoint,"MM/dd/yyyy"));
        }
        return order;
    }
}