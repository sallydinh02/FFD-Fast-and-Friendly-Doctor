...
public class PatientAppointmentPayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //pay button
        final boolean[] clickedPay = {false};
        MaterialCardView buttonPay = (MaterialCardView) view.findViewById(R.id.buttonPay);
        TextView payNext=(TextView) view.findViewById(R.id.payNext);
        RelativeLayout layoutPayNext=(RelativeLayout) view.findViewById(R.id.layoutPayNext);
        buttonPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    clickedPay[0] =true;
                    payNext.setTextColor(Color.parseColor("#ffeac7"));
                    //Add Zalo API here
                    ...
                    try {
                        JSONObject data = orderApi.createOrder("500");
                        ...
                        layoutPayNext.setVisibility(View.VISIBLE);
                        payNext.setTextColor(Color.parseColor("#0d75df"));
        ...
        layoutPayNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (clickedPay[0])
                {
                    ...
                    if (getArguments().getString("messageFromBookToPay")!=null)
                    {
                    ...
                    else if (getArguments().getString("messageFromCallToPay")!=null)
                    {
                        String valueCall=getArguments().getString("messageFromCallToPay");
                        fragment=new PatientVideoCallFragment();
                    }
                    FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                    transaction.add(R.id.patientAppointmentPayContainer,fragment, "step7YourOrder");
                    transaction.addToBackStack(null);
