...
public class PatientOrderDetailCallLaterFragment extends Fragment {
    ...
    public void onViewCreated(View v, Bundle b){
        ...
        orderPatientDob.setText(FirebaseNumberAndDateTimeProcess.dateToString(Patient.CurrentPatient.DateOfBrith, "MM/dd/yyyy"));
        ...
        o.DateAppoint= FirebaseNumberAndDateTimeProcess.stringToDate(getDate,"MM/dd/yyyy");
        orderDate.setText(FirebaseNumberAndDateTimeProcess.dateToString(o.DateAppoint,"MM/dd/yyyy"));
    }
}