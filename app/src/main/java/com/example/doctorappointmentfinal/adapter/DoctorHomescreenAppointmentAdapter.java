...
public class DoctorHomescreenAppointmentAdapter extends
    ...
    public DoctorHomescreenAppointmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate= LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_doctornextappointment, parent, false);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        for(QueryDocumentSnapshot q: task.getResult()){
                            ...
                            holder.patientName.setText(FirebaseNumberAndDateTimeProcess.dateToString(p.DateOfBrith,"MM/dd/yyyy"));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            dateAndTime = itemView.findViewById(R.id.doctorAppointmentDateTime);
            patientAvatar = itemView.findViewById(R.id.doctorAppointmentPatientPic);
            doctorName = itemView.findViewById(R.id.doctorAppointmentPatientName);
            faculty = itemView.findViewById(R.id.doctorAppointmentPatientGender);
            patientName = itemView.findViewById(R.id.doctorAppointmentPatientDob);
        }
