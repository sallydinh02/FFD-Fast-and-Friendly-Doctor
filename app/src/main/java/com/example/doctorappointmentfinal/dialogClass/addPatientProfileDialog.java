                ...
                db.collection("Patients").get()
                        .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                            ...
                            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                ...
                                Patient p=new Patient("P"+Integer.toString(numberOfPatients+1),userFullName, s.getSelectedItemId()==0?false:true, FirebaseNumberAndDateTimeProcess.stringToDate(dob,"MM/dd/yyyy"),"","","",Patient.CurrentPatient.ID,"person");
